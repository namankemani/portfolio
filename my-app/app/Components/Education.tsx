    ...
    return(
        <section className="my-20">
            ...
            <div className="w-full md:flex items-center justify-between text-white mt-10 ">
                <div className="bg-white/70 text-black m-6 p-4 rounded-3xl md:w-1/2 md:ml-8">
                    <div className="flex items-baseline justify-between">
                        <span className="mx-2 py-2 px-4 my-2 rounded-3xl bg-amber-400  font-bold">2021-2025</span>
                        <span className="mx-2 py-2 px-4 my-2 rounded-3xl bg-white font-bold">Graduation</span>
                    </div>
                    <div className="flex items-center justify-start">
                        <span className="mx-2 py-2 px-4 my-2 rounded-3xl bg-white font-bold">Bahelors Degree</span>
                        <span className="mx-2 py-2 px-4 my-2 rounded-3xl bg-white  font-bold">B.Tech</span>
                    </div>
                ...
                <div className="bg-white/70 text-black m-6 p-4 rounded-3xl md:w-1/2 ">
                    <div className="flex items-baseline justify-between">
                        <span className="mx-2 py-2 px-4 my-2 rounded-3xl bg-amber-400  font-bold">2019-2020</span>
                        <span className="mx-2 py-2 px-4 my-2 rounded-3xl bg-white font-bold">Intermediate</span>
                    </div>
                    <div className="flex items-center justify-start">
                        <span className="mx-2 py-2 px-4 my-2 rounded-3xl bg-white font-bold">12th</span>
                        <span className="mx-2 py-2 px-4 my-2 rounded-3xl bg-white  font-bold">PCM</span>
                    </div>
